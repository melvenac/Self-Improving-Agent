...
export function syncReadmeVersion(version, projectRoot, checkOnly) {
...
export function syncPrdVersion(version, projectRoot, checkOnly) {
...
export function syncKmcpVersion(version, projectRoot, checkOnly) {
...
export function checkChangelog(version, projectRoot) {
...
export function checkReadmeRefs(projectRoot) {
    const readmePath = join(projectRoot, "README.md");
    if (!existsSync(readmePath)) {
...
export function checkHookConfigs(settingsPath) {
...
export function checkSummary(version, projectRoot) {
...
export function checkClaudeMd(projectRoot) {
...
export function checkObsidianVault(vaultPath) {
...
export function checkTemplate(projectRoot) {
...
export function checkInstalledDrift(projectRoot, homePath, checkOnly) {
    ...
    for (const [repoDir, instDir, exts] of [
        ...
        if (!existsSync(repoDir) || !existsSync(instDir))
            continue;
...
export function checkSpecProvenance(projectRoot, dbPath) {
...
export function checkRules(projectRoot) {
